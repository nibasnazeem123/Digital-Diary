...
export class CalenderComponent {
  ...
  value :any;
  myBirthday: any;
public minDate: Date = new Date ("05/07/2022");
    public maxDate: Date = new Date ("08/27/2028");

    constructor (public datepipe: DatePipe,private http: HttpClient,private notify: Notifications) { let currentDateTime =this.datepipe.transform((new Date), 'dd/mm/yyyy');
    this.currdate=currentDateTime;
    this.myBirthday=currentDateTime;
  }
  ngOnInit(): void {
    this.http.jsonp < MbscCalendarEvent[] > ('https://localhost:44351/api/Event/viewdata', 'callback').subscribe((resp) => {
        //this.myEvents = resp;
    });
}
  @ViewChild('popup', { static: false })
    ...
    // }, {
    //     id: 4,
    //     start: '2023-01-03T10:30',
    //     end: '2023-01-03T11:30',
